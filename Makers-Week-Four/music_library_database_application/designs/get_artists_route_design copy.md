...
describe Application do
  ...
  context "GET /artists" do
    it 'returns a list of all artist names in database' do
      response = get('/artists')

      expect(response.status).to eq(200)
      all_artists = 'Pixies', 'ABBA', 'Taylor Swift','Nina Simone'
      expect(response.body).to eq(all_artists)
