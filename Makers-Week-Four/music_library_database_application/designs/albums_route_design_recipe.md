...
Route signature:
  ...
  * the path: /albums 
  * Body parameters (passed in the request body): title, release_year, artist_id
...
Response when the artist found: 200 OK

No body return. A new album object will be created in database with title, release_year and artist
...
Post/albums (body params: title = 'midnights' release_year = '2022' artist_id = '3' )
...
describe Application do
  ...
  context "POST /albums" do
    it 'creates a new album object' do
      ...
      response = get('/albums', title: "midnights", release_year: "2022", artist_id: "3" )
